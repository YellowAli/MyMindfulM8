...
function Page1() {
    ...
    return (
        <div className="container">
            <div className="header-container">Your current focus is: <br/>Mental Health</div>
            ...
            <p className="card-text">"Affirmations, when practiced consistently, have been shown to decrease health-deteriorating stress, 
            can be beneficial in significantly improving optimism and feelings of hope, and may also aid in the mitigation of the effects of negative emotional bias, a common feature in depressive disorders."</p>
            </div>
            </div>
            ...
            <p className="card-text">"Journaling has been associated with reduced stress and improved mood by helping individuals process emotions and increase self-awareness."</p>
            </div>
            </div>
            </div>
            ...
            <p className="card-text">"Deep breathing techniques have been linked to decreased anxiety and an enhanced relaxation response through the activation of the parasympathetic nervous system."</p>
            </div>
            </div>
            ...
            <p className="card-text">"Expressing gratitude consistently is correlated with long-term well-being, reduced depression, and increased happiness, fostering a positive mindset and stronger resilience."</p>
            </div>
            </div>
            </div>
